...
const CarModal = ({
  ...
  const [lastCheckedReferenceNumber, setLastCheckedReferenceNumber] = useState<number | null>(null);
  ...
  const handleMagicCollarReferenceNumberChange = (
    ...
    onChange && onChange(referenceNumber ?? null);
    ...
    collarFetchTimeout.current = setTimeout(async () => {
                ...
                <>
                  ...
                  >
                    {(props) => (
                      ...
                      >
                        {value || defaultValues.existingAttachment
                          ? "Replace image"
                          : "Upload image"}
                      </Button>
                    )}
